...
for data_name in ['V1_Human_Heart', 'V1_Human_Lymph_Node','V1_Breast_Cancer_Block_A_Section_1', 'Targeted_Visium_Human_BreastCancer_Immunology']:

    params.epochs = 200
    print('running SEDR for', data_name)
    ...
    axes = sc.pl.spatial(adata_sedr, img_key="hires", color=['SEDR_leiden'], save=data_name+"_SEDR_leiden_plot", show=False)

    axes[0].figure.savefig(os.path.join(params.save_path, "SEDR_leiden_plot.png"), bbox_inches='tight', dpi=150)
    # plt.savefig(os.path.join(params.save_path, "SEDR_leiden_plot.png"), bbox_inches='tight', dpi=150)
    # plt.close()
