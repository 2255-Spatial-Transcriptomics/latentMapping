...
def train_val_split(adata, train_frac=0.85):
    """
        from https://github.com/theislab/trVAE/blob/master/trvae/utils.py
        ...
        val_adata: :class:`~anndata.AnnData`
            Validation annotated dataset.
    """
