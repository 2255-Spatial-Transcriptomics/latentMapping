...
class VAE2(BaseMinifiedModeModuleClass):
    """
    ...
    def loss(
        ...
        # compute the euclidean loss. Currently, the euclidean loss is added to the reconstruction loss
        # to form the total loss, however, this is not, for some reason being used to constraint/optimize 
        # the latent space generated by VAE2.
        # if self.models['vae1'].is_trained and self.models['vae2'].is_trained:
        #     # compute the discriminator loss with gradients on both vaes
        #     print(f'# times running loss, {self.loss_count}')
        #     self.loss_count += 1
        #     # vae1 = self.models['vae1']
        ...
        #     #Print the reconstruction loss along with the similarity loss to see if the similarity loss is decreasing as well.
        #     print(f'reconstruction loss, {loss} and similarity loss {similarity_loss}')
